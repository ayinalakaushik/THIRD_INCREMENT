...
public class connection {
    ...
    public void push(String id,String desc, double longitude,double latitude) throws IOException {
        RequestTask requestTask = new RequestTask(id,desc,longitude,latitude);
        requestTask.execute("");
    }
    ...
    class RequestTask extends AsyncTask<String, String, String> {
        ...
        public RequestTask(String id,String desc, double longitude,double latitude){
            this.id=id;
            this.desc=desc;
